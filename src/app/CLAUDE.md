...
- Route groups use parentheses to separate concerns: `(landing)`, `(legal)`, `(auth)`, `workspace`. Public Clerk sign-in/sign-up routes belong in `(auth)`; protected authenticated workspace flows belong in `workspace`.
