...
`buttonLabel` → neuer CTA; `formButton` (Mock-Formular in der Grafik) → „Ersteinschätzung anfragen" (EN: „Request
initial assessment"), damit die Grafik das echte Formular spiegelt.
...
| 3   | Preis- und Umfangslogik schärfen: Pricing-Karte, FAQ, Inclusions, 2 Feedback-Runden (DE+EN); EN-Drift synchronisieren + Structured-Data-Check (siehe Hinweise in Abschnitt 7)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `dictionaries/landing/{pricing,faq,inclusions}/{de,en}.json`, `dictionaries/landing/structured-data/{de,en}.json` (nur Check)                                          |
...
| 5   | Solution-Grafik (Fake-Rating raus; `formButton` des Mock-Formulars „Anfrage senden"/„Send inquiry" ans Submit-Label angleichen), Process Schritt 1 „Ersteinschätzung" (DE+EN)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | `dictionaries/landing/{solution,process}/{de,en}.json`                                                                                                                 |
