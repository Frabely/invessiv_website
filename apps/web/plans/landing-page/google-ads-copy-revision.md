...
Hinweis: Die UTM-Whitelist im Vercel-Analytics-Sanitizer ist dort aktuell nur als optionaler Follow-up notiert — vor
Ads-Start dort prüfen/priorisieren, falls Kampagnenauswertung in Vercel Analytics gebraucht wird.
...
| #   | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Scope (Dateien)                                                                                                                                                      |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | CTA-Texte vereinheitlichen (DE+EN) — Skill-Datei wurde bereits vorab vollständig auf die neue Linie aktualisiert ✓                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | `dictionaries/landing/{header,hero,audience,pricing,solution,final-cta}/{de,en}.json`                                                                                |
...
- `npm run lint`, `npm run typecheck`, betroffene Tests (`final-cta-section.test.tsx`, `landing-page.test.tsx`),
  `npm run build`
