...
describe("LandingRoute", () => {
  ...
  it("creates locale-specific landing metadata", async () => {
    ...
    expect(metadata.title).toEqual({
      absolute: "Landingpage erstellen lassen | in 5–10 Tagen | Invessiv",
    });
    expect(metadata.description).toBe(
      "Schnelle, klare Landingpages für Dienstleister und KMU – online in 5–10 Tagen. Struktur, Design und Technik aus einer Hand. Kostenlose Ersteinschätzung anfragen.",
    );
    expect(metadata.openGraph).toMatchObject({
      ...
      locale: "de_DE",
      siteName: "Invessiv",
      title: "Landingpage erstellen lassen | in 5–10 Tagen | Invessiv",
      type: "website",
