...
const HOME_SECTIONS = [
  ...
  },
  {
    ...
    copy: {
      de: {
        title: "So wird aus einer losen Anfrage ein umsetzbarer Plan",
        description:
          "Vier Etappen nehmen Unsicherheit aus dem Start: erst Rahmen, dann sichtbarer Draft, dann Umsetzung, dann sauberer Launch.",
        summaryPoints: [
          "kein fertiges Briefing nötig",
          "früher Draft statt langer Theorie",
          "QA + Übergabe vor dem Livegang",
        ],
        processSteps: [
          {
            step: "01",
            title: "Rahmen festziehen",
            deliverable: "Briefing-Notiz + Empfehlung",
            effort: "Output: Briefing-Notiz + Empfehlung",
            result: "Entscheidung: passendes Leistungsmodell",
            description:
              "Wir klären Ziel, Zielgruppe, vorhandenes Material und Rahmen. Danach ist klar, welches Leistungsmodell wirklich passt.",
          },
          {
            step: "02",
            title: "Erste Route bauen",
            deliverable: "Struktur, Draft oder Prototyp",
            effort: "Output: Struktur, Draft oder Prototyp",
            result: "Sichtbar: Seitenlogik oder Kern-Workflow",
            description:
          ...
          {
            step: "03",
            title: "Ausarbeiten & prüfen",
            deliverable: "Umsetzung mit Copy und QA",
            effort: "Output: Umsetzung mit Copy und QA",
            result: "Stand: freigabereife Version",
            description:
              "Danach folgt die Umsetzung mit den nötigen Inhalten, Details und QA-Schritten bis zur sauberen Freigabe.",
          },
          {
            step: "04",
            title: "Live bringen & übergeben",
            deliverable: "Launch oder Integration",
            effort: "Output: Launch oder Integration",
            result: "Übergabe: nächste Schritte klar",
            description:
      ...
      en: {
        title: "Turn a loose request into an actionable plan",
        description:
          "Four stages remove uncertainty from the start: frame first, then visible draft, then implementation, then a clean launch.",
        summaryPoints: [
          "no finished brief needed",
          "early draft instead of long theory",
          "QA + handover before launch",
        ],
        processSteps: [
          {
            step: "01",
            title: "Lock the frame",
            deliverable: "Briefing note + recommendation",
            effort: "Output: briefing note + recommendation",
            result: "Decision: fitting service model",
            description:
              "We align on the goal, audience, available materials, and frame. After that, the service model that actually fits is clear.",
          },
          {
            step: "02",
            title: "Build the first route",
            deliverable: "Structure, draft, or prototype",
            effort: "Output: structure, draft, or prototype",
            result: "Visible: page logic or core workflow",
            description:
              "I develop the page logic or first prototype. This shows early whether the offer, content, and inquiry path work together.",
          },
          {
            step: "03",
            title: "Build out & check",
            deliverable: "Implementation with copy and QA",
            effort: "Output: implementation with copy and QA",
            result: "Status: approval-ready version",
            description:
          ...
          },
          {
            ...
            deliverable: "Launch or integration",
            effort: "Output: launch or integration",
            result: "Handover: next steps clear",
            description:
