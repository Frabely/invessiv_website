...
- Jede Datei hat eigenen Fortschritt, Fehler und Retry; erfolgreiche Dateien werden nicht zurück-
  gerollt, wenn eine andere Datei scheitert.
...
5. Mehr als 100 Dateien oder über 300 MB werden verständlich abgelehnt, bevor die Erstellung beginnt.
...
8. Ein Archiv an der Obergrenze bleibt innerhalb des Zeitbudgets und lässt den Serverspeicher nicht anwachsen.
