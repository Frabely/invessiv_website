...
| Löschen              | Soft-Delete über `deleted_at`; alle Projekt-Abfragen filtern darauf                                            |
...
- **Inhalt:**
  ...
  - Löschen nur mit `Permission.ProjectsWrite`, Bestätigung im UI; Soft-Delete setzt `deleted_at`
