...
> **Verbindliche Revision 2026:** Gehört zu Merge-Einheit 16.

## Verbindliche Revision

- CRM zeigt alle Einreichungen mit Runde, Kunde, Projekt, Status, Text und Dateien.
- Interne Statusaktionen sind ausschließlich `in_progress` und `completed`; es gibt keine
  Kundenfreigabeaktion und kein Zurücksetzen einer abgeschlossenen Runde.
- Zusatzrunden-Anfrage wird owner-/berechtigungsgeprüft angenommen oder abgelehnt; Annahme erzeugt
  genau eine neue Runde.
- Antworttext ist separate Activity/Message und kein Überschreiben der ursprünglichen Einreichung.
