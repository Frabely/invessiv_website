...
| Custom-Rolle       | Name 1–80 Zeichen, Beschreibung ≤ 280, nur delegierbare Workspace-Permissions; Name eindeutig je Realm (DB-Index); kein Name einer Systemrolle — weder DB-Name noch übersetztes Label einer Sprache (`ROLE_NAME_RESERVED`, Review 14.09.2026)                                                                     |
...
| `POST /api/workspace/roles`                    | `roles.manage`   | 201    | 400 Validierung · 409 Name vergeben · 409 Systemrollen-Name · 422 nicht delegierbare Permission                  |
| `PATCH /api/workspace/roles/[id]`              | `roles.manage`   | 200    | 404 · 409 Version · 409 Name vergeben · 409 Systemrollen-Name · 422 Systemrolle · 422 nicht delegierbar          |
