...
- Beim neuen Kunden muss der Primärkontakt im Dialog neu eingegeben oder bestätigt werden; Leadwerte
  sind nur Vorschläge.
- Weitere Leadkontakte sind auswählbar und werden als globale Personen verknüpft oder angelegt.
- Beim bestehenden Kunden bleiben Stammdaten und Primärkontakt unverändert; fehlende Kontakte werden
  optional zugeordnet.
