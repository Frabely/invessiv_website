...
| Bringschuld                 | Aufgaben mit `responsible_side = customer` **und** `visible_to_customer`, offen zuerst                                  |
...
- **Inhalt:**
  - Nur vorhandene Ziele verlinken: Preview, wenn eine URL gesetzt ist. Hochladen und Feedback
    erscheinen erst mit Task 22 — dort ebenso der Download freigegebener Ergebnisse —, das Stundenkontingent erst mit Task 27
