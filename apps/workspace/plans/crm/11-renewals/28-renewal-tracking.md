...
- Jeder Renewal hat `assignee_member_id`, initial den bei der Kundenanlage vorhandenen technischen Kunden-Owner und
  danach unabhängig änderbar. Ein einzelner Kunden-Owner-Wechsel in Ordner 20a überschreibt bestehende Renewals nicht.
