...
**Aktueller Nachtrag:** Die Shared-Pfade für Badge, Detail-Grundbausteine, Tabellenmechanik, Suche, Facettenfilter und
Timeline sind inzwischen angelegt und die Workspace-Imports zeigen darauf. Die verbleibenden Arbeiten sind die
vollständige
app-neutrale Entkopplung, Mehrfachauswahl, native Dialog-Testabdeckung, Detail-Panel-Komposition und der
Abschlussnachweis.
...
| 02e-6               | `ConfirmDialog`, Single-Delete, Bulk-Archiv und Bulk-Löschen umgestellt; vier Lead-Dialoge noch mit Eigenbau-Overlay/Fokusfalle. |
