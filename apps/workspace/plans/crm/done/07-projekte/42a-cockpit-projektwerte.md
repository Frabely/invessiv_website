...
Die bestehende Cockpit-Aggregation aus Task 08b/08c wird um die aus `project_line_items` berechneten
...
- Werte werden nur mit `project_line_items.read` in Liste und Dialog geliefert und gerendert.
