...
| 3   | Allowlist-User -> `/de/dashboard`            | Owner-Check offen | Erfordert Clerk-Test-Login mit E-Mail aus `WORKSPACE_ALLOWED_EMAILS`. Erwartung: deutsche Dashboard-Headline.                         |
| 4   | Owner -> `/en/dashboard`                     | Owner-Check offen | Erfordert Clerk-Test-Login mit E-Mail aus `WORKSPACE_ALLOWED_EMAILS`. Erwartung: englische Dashboard-Headline.                        |
