...
| Mehrfaches Anwenden | Erlaubt, aber bereits vorhandene Titel werden übersprungen (keine Dubletten)                                                                           |
...
- **Inhalt:**
  ...
  - Titel aus dem Dictionary der aktuellen Locale auflösen (Text wird gespeichert, nicht der Key —
    der Nutzer soll ihn später frei umformulieren können)
  - Vorhandene Titel im selben Projekt werden übersprungen; das Ergebnis nennt angelegte und
    übersprungene Anzahl
- **Akzeptanz:**
  - Test: zweimaliges Anwenden erzeugt keine Dubletten
