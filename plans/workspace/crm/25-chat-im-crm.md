...
| Gemeinsame Komponente | `components/shared/message-thread/**` — app-intern geteilt, nicht in `packages/ui` (sie hängt an den Nachrichten-Verträgen, die workspace-spezifisch sind) |
...
```txt
apps/workspace/src/components/shared/message-thread/
...
- **Files:** `components/shared/message-thread/**`,
