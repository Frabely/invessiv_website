...
| `src/server/workspace/outreach/generate-outreach.schema.ts`                                      | NEU    | Zod-Schema gegen Request-DTO — Domain-Root, zwischen Route und Command-Handler                                                                                                                     |
| `src/server/tests/workspace/outreach/services/generate-outreach.schema.test.ts`                  | NEU    | Schema-Tests (TDD) — in `src/server/tests/` per Konvention                                                                                                                                         |
