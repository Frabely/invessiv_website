...
export type UpdateProjectLineItemResult =
  ...
  | { ok: false; code: typeof ProjectLineItemErrorCode.ProjectLineItemNotFound }
  | {
      ok: false;
      code: typeof ConcurrencyErrorCode.VersionConflict;
      conflict: VersionConflictDto<ProjectLineItemDto>;
    };
